...
General game functionality includes the [master server](http://masterserver2.raknet.com/), crash reporting, email sending through Gmail pop servers, and an SQL logging server.
...
Next page: [Detailed Implementation](/getting-started/detailed-implementation)
