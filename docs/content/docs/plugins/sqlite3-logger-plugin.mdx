...
Note the parenthesis around the parameter list. This is necessary for the macro to automatically log the \_\_FILE\_\_ and \_\_LINE\_\_ values that it uses in C++.
...
Via macros, the values for \_\_FILE\_\_ and \_\_LINE\_\_ are also automatically sent to the server.
