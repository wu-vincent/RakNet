...
The server should load the public and private keys, and pass them to `RakPeerInterface::InitializeSecurity()`.
...
The client should load the public key. The public key should be distributed with the client application, or downloaded from a secure location. Pass the public key to `RakPeerInterface::Connect()`.
