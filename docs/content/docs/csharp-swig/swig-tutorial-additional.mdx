...
<Callout type="info">
These are replacement steps. If the DLL project is used, the `PreBuild.bat` needs to be modified -- see the last steps for instructions on how to do that.
</Callout>
