...
Note: Connect() returning true does NOT mean you are connected. If successful the message ID_CONNECTION_REQUEST_ACCEPTED should be received. If not you will receive one of the error messages.
...
Assuming you are able to connect, it is time to go onto the section: [Creating Packets](/basics/creating-packets)
