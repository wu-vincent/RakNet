...
Before you can use the distributed object system, you have to register your instance of `RakClient` and/or `RakServer` with the `DistributedNetworkObjectManager`.
