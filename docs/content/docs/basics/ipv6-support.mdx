...
IPV6 is the next-generation of IP address. IPV6 was developed because all available IPV4 addresses have been allocated. Over time the industry will transition to use IPV6 so it is necessary to support this for future-generation applications.
